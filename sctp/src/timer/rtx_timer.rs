...
pub const RTO_INITIAL: u64 = 3000; // msec
pub const RTO_MIN: u64 = 1000; // msec
pub const RTO_MAX: u64 = 60000; // msec
pub const RTO_ALPHA: u64 = 1;
pub const RTO_BETA: u64 = 2;
pub const RTO_BASE: u64 = 8;
pub const MAX_INIT_RETRANS: usize = 8;
pub const PATH_MAX_RETRANS: usize = 5;
pub const NO_MAX_RETRANS: usize = 0;
...
impl RtoManager {
    ...
    pub fn set_new_rtt(&mut self, rtt: u64) -> u64 {
        if self.no_update {
            return self.srtt;
        }
    ...
    pub fn set_rto(&mut self, rto: u64, no_update: bool) {
        self.rto = rto;
        self.no_update = no_update;
    }
}

pub fn calculate_next_timeout(rto: u64, n_rtos: usize) -> u64 {
...
#[derive(Default, Debug)]
pub struct RtxTimer<T: 'static + RtxTimerObserver + Send> {
    pub timeout_observer: Weak<Mutex<T>>,
    pub id: RtxTimerId,
    pub max_retrans: usize,
...
impl<T: 'static + RtxTimerObserver + Send> RtxTimer<T> {
    ...
    pub async fn start(&self, rto: u64) -> bool {
